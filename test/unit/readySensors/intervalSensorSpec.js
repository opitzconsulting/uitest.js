describe('interval sensor', function() {
    var sensorModule, readyModule, config, injectorModule, sensorInstance, handle, setInterval, clearInterval, win;
    beforeEach(function() {
        readyModule = {
        ...
        var modules = uitest.require({
            ready: readyModule
        }, ["intervalSensor", "injector"]);
        sensorModule = modules.intervalSensor;
