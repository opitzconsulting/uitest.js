...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    ...
    do {
      var l = j.exec(h) || ["", "", ""], k = m.exec(i) || ["", "", ""];
      if(0 == l[0].length && 0 == k[0].length) {
        break
      }
      var c = 0 == l[1].length ? 0 : parseInt(l[1], 10), n = 0 == k[1].length ? 0 : parseInt(k[1], 10), c = goog.string.compareElements_(c, n) || goog.string.compareElements_(0 == l[2].length, 0 == k[2].length) || goog.string.compareElements_(l[2], k[2])
    }while(0 == c)
  }
  return c
};
...
bot.Keyboard.prototype.updateOnCharacter_ = function(a) {
  if(!bot.Keyboard.KEYPRESS_EDITS_TEXT_) {
    var a = this.getChar_(a), b = goog.dom.selection.getStart(this.getElement()) + 1;
...
bot.action.type = function(a, b, c, d) {
  function e(a) {
    goog.isString(a) ? goog.array.forEach(a.split(""), function(a) {
      var a = bot.Keyboard.Key.fromChar(a), b = f.isPressed(bot.Keyboard.Keys.SHIFT);
...
bot.action.multiTouchAction_ = function(a, b, c, d, e) {
  var d = bot.action.prepareToInteractWith_(a, d), f = bot.action.getInteractableSize(a), f = new goog.math.Vec2(Math.min(d.x, f.width - d.x), Math.min(d.y, f.height - d.y)), e = e || new bot.Touchscreen;
  b(f);
...
bot.inject.executeAsyncScript = function(a, b, c, d, e, f) {
  ...
  var i = f || window, j, m = !1, f = goog.partial(g, bot.ErrorCode.UNKNOWN_ERROR);
  if(i.closed) {
    ...
    try {
      ...
      g(k.code || bot.ErrorCode.UNKNOWN_ERROR, k)
    }
  }
};
...
webdriver.atoms.element.getText = function(a) {
  if(webdriver.atoms.element.isInHead_(a)) {
    ...
    return a.tagName.toUpperCase() == goog.dom.TagName.TITLE && goog.dom.getWindow(b) == bot.getWindow().top ? goog.string.trim(b.title) : ""
  }
...
webdriver.atoms.inputs.mouseMove = function(a, b, c, d) {
  var d = new bot.Mouse(d), e = a || d.getState().element, f = null != b && null != c, b = b || 0, c = c || 0;
...
webdriver.atoms.inject.executeAsyncScript = function(a, b, c, d, e) {
  return bot.inject.executeAsyncScript(a, b, c, d, !0, webdriver.atoms.inject.getWindow_(e))
};
...
core.events.getEventFactory_ = function(a) {
  var b = "";
  a && (b = a.toUpperCase());
  return(b = bot.events.EventType[b]) ? b : {create:function(b) {
